...
public static class Utils {
    ...
    public static void logd(string id, string message, bool ignoreDuplicates=false, GameObject highlightGO = null) {
    ...
    public static void logw(string id, string message, bool ignoreDuplicates=false, GameObject highlightGO = null) {
        if(ignoreDuplicates && lastIdMessage.ContainsKey(id) && lastIdMessage[id]==message) {
            return;
        }
        if(highlightGO) {
    ...
    public static void loge(string id=null, string message=null, bool ignoreDuplicates=false, GameObject highlightGO = null) {
        if(ignoreDuplicates && lastIdMessage.ContainsKey(id) && lastIdMessage[id]==message) {
            return;
        }
        if(highlightGO) {
