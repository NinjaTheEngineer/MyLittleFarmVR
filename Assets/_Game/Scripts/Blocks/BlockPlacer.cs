...
public class BlockPlacer : NinjaMonoBehaviour {
    ...
    public Vector3 fxOffset = new Vector3(0, 0.3f, 0);
    ...
    public void PlaceBlock() {
        ...
        if (IsPlacingBlock && previewBlock.InValidPosition) {
            ...
            AudioManager.Instance.PlaySFX(SoundType.PlaceBlock, transform.position, 0.45f);
            ParticleSystemManager.Instance.PlayParticleSystem(ParticleType.PlaceBlock, previewBlock.transform.position + fxOffset);    
